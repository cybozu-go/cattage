...
func init() {
	...
	utilruntime.Must(multitenancyv1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "309b12c3.cybozu.com",
	})
	if err != nil {
	...
	if err = (&multitenancyv1beta1.Tenant{}).SetupWebhookWithManager(mgr); err != nil {
